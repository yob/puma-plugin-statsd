  ...
  def stats_loop
    ...
    loop do
      ...
      begin
        ...
        @statsd.send(metric_name: prefixed_metric_name("puma.backlog"), value: stats.backlog, type: :histogram, tags: tags)
        @statsd.send(metric_name: prefixed_metric_name("puma.pool_capacity"), value: stats.pool_capacity, type: :histogram, tags: tags)
        ...
        @statsd.send(metric_name: prefixed_metric_name("puma.percent_busy"), value: stats.percent_busy, type: :histogram, tags: tags)
